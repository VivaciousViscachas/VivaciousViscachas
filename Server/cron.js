...
module.exports.test = request('https://api.meetup.com/2/open_events?&category=34&zip=78701&radius=20&page=1&key='+process.env.MEETUP_KEY, function (error, response, body){
    if (error) {
